...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("Blessingmadhuma")
    self.driver.find_element(By.ID, "password").send_keys("WIKNELL")
  ...
  def test_homePage(self):
    ...
    elements = self.driver.find_elements(By.CSS_SELECTOR, "#hamburger-equiv > img")
    assert len(elements) > 0
  ...
  def test_joinPage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(697, 720)
    self.driver.find_element(By.NAME, "fname").send_keys("Blessing")
    self.driver.find_element(By.NAME, "lname").send_keys("Madhuma")
    self.driver.find_element(By.NAME, "bizname").send_keys("Blessing")
    self.driver.find_element(By.NAME, "biztitle").send_keys("chairman")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Chairman")
